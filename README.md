...
Lax submission `lax-888664`, using Lean `v4.30.0` and mathlib revision
...
- [Definition of P](concepts/Lax888664/PolynomialTime.lean)
- [Complement closure statement](concepts/Lax888664/ComplementClosure.lean)
- [Machine construction and proof](proofs/Lax888664Proofs/ComplementClosure.lean)
- [Independent machine models](concepts/Lax888664/MachineModels.lean)
- [Finite stack alphabets suffice](concepts/Lax888664/FiniteStackEquivalence.lean)
- [Single-tape characterization](concepts/Lax888664/ModelEquivalence.lean)
- [Single-tape complement closure](concepts/Lax888664/SingleTapeComplement.lean)
- [Model equivalence proofs and single-tape complement closure](proofs/Lax888664Proofs/ModelEquivalence.lean)
